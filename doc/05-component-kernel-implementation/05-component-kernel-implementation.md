...
I chose to represent SkydiveJumpLog using three integers: jumpCount, totalAltitude, and lastJumpAltitude.

This representation is simple and makes the kernel methods easy to implement. For example, recording a jump just updates these values directly. It also allows quick access to information like the number of jumps and total altitude without needing extra computation.
...
- Designed kernel implementation for SkyDiveJumpLog component
